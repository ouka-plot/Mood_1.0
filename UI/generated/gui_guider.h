...
typedef struct
{
	...
	bool screen_2_del;
		...
		lv_obj_t *screen_2_label_q_header;
		lv_obj_t *screen_2_label_q_1;
		lv_obj_t *screen_2_label_q_2;
		lv_obj_t *screen_2_label_q_3;
		lv_obj_t *screen_2_label_q_4;
		lv_obj_t *screen_2_label_q_5;
		lv_obj_t *screen_2_label_hint;
	lv_obj_t *screen_3;
	bool screen_3_del;
	lv_obj_t *screen_3_label_title;
	lv_obj_t *screen_3_label_status;
	lv_obj_t *screen_3_label_time;
	lv_obj_t *screen_3_label_size;
	lv_obj_t *screen_3_btn_rec;
	lv_obj_t *screen_3_btn_rec_label;
	lv_obj_t *screen_3_btn_pause;
	lv_obj_t *screen_3_btn_pause_label;
	lv_obj_t *screen_3_btn_back;
	lv_obj_t *screen_3_btn_back_label;
	lv_obj_t *screen_3_label_hint;
	lv_obj_t *screen_3_label_led;
}lv_ui;
